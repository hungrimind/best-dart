...
void main() {
  ...
  test('Handles too high guess then correct guess', () async {
    ...
    expect(output, contains('Too high!'),
        reason: 'Program should print "Too high!" when guess is greater than secret number');
    expect(output, contains('You got it!'),
        reason: 'Program should print "You got it!" when guess is correct');
    expect(exitCode, equals(0),
        reason: 'Program should exit successfully after correct guess');
  ...
  test('Handles too low guess then correct guess', () async {
    ...
    expect(output, contains('Too low!'),
        reason: 'Program should print "Too low!" when guess is less than secret number');
    expect(output, contains('You got it!'),
        reason: 'Program should print "You got it!" when guess is correct');
    expect(exitCode, equals(0),
        reason: 'Program should exit successfully after correct guess');
  ...
  test('Handles multiple incorrect guesses before correct guess', () async {
    ...
    expect(output, contains('Too high!'),
        reason: 'Program should print "Too high!" for guesses greater than secret number');
    expect(output, contains('Too low!'),
        reason: 'Program should print "Too low!" for guesses less than secret number');
    expect(output, contains('You got it!'),
        reason: 'Program should print "You got it!" when guess is correct');
    expect(exitCode, equals(0),
        reason: 'Program should exit successfully after correct guess');
  ...
  test('Continues looping until correct guess', () async {
    ...
    expect(guessPromptCount, greaterThan(1),
        reason: 'Program should repeatedly ask for guesses using a while loop until correct answer');
    expect(output, contains('You got it!'),
        reason: 'Program should eventually print "You got it!" when correct guess is made');
    expect(exitCode, equals(0),
        reason: 'Program should exit successfully after correct guess');
  });
}
