...
void main() {
  test('defines Player class with correct properties and default values', () async {
  ...
  test('player2 retains default values independently', () async {
    ...
    expect(
      ...
      reason: 'Player2 username should remain "Guest" (default value), showing that objects are independent.',
    );

    expect(
      output,
      contains('Health: 100'),
      reason: 'Player2 health should remain 100 (default value), showing that objects are independent.',
    );

    expect(
      output,
      contains('Score: 0.0'),
      reason: 'Player2 score should remain 0.0 (default value), showing that objects are independent.',
    );
  });
