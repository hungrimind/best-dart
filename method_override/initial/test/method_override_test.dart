  ...
  group('Method Override Tests', () {
    test('Document save() method prints correct message', () async {
      ...
      expect(
        ...
        reason: 'Document class should print "Saving the document to a file..." when save() is called',
      );
    });

    test('Receipt save() method overrides parent and prints correct message', () async {
      final result = await Process.run(
        'dart',
        ['run', 'bin/method_override.dart'],
        runInShell: true,
      ...
      expect(
        ...
        reason: 'Receipt class should override save() and print "Saving the receipt to the accounting system..."',
      );
    });

    test('Both Document and Receipt save() methods are called correctly', () async {
      final result = await Process.run(
        'dart',
        ['run', 'bin/method_override.dart'],
        runInShell: true,
      ...
      final receiptSaveIndex = lines.indexWhere((line) => 
