  ...
  group('takeDamage method', () {
    test('should reduce health by the damage amount', () async {
      ...
      expect(
        result.exitCode,
        0,
        reason: 'The program should run without errors. Make sure you have created the takeDamage method.',
      );
      ...
      expect(
        ...
        reason: 'After taking 25 damage, health should be 75 (100 - 25). The takeDamage method should subtract damageAmount from health.',
      );
    });
    ...
    test('should handle multiple damage calls correctly', () async {
      ...
      expect(
        ...
        reason: 'After taking 25 damage then 10 more damage, health should be 65 (100 - 25 - 10). The takeDamage method should continue to modify health correctly.',
      );
    });
